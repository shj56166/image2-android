...
val releaseSigningPropertiesFile = listOf(
    ...
    File(System.getProperty("user.home"), ".android/image2-release-signing.properties"),
...
android {
    namespace = "com.shj56166androidimage2.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.shj56166androidimage2.app"
        minSdk = 29
        targetSdk = 35
        versionCode = 1
        versionName = "0.1.0"
